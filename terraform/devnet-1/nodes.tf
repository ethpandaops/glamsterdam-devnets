...
variable "nodes" {
  ...
  default = [
    ...
    { name = "lodestar-geth", count = 1, cloud = "hetzner", validator_start = 1500, validator_end = 2000 },
    { name = "lighthouse-ethrex", count = 1, cloud = "hetzner", validator_start = 2000, validator_end = 2500 },
    { name = "prysm-ethrex", count = 1, cloud = "hetzner", validator_start = 2500, validator_end = 3000 },
    { name = "teku-ethrex", count = 1, cloud = "hetzner", validator_start = 3000, validator_end = 3500 },
    { name = "lodestar-ethrex", count = 1, cloud = "hetzner", validator_start = 3500, validator_end = 4000 }
  ]
